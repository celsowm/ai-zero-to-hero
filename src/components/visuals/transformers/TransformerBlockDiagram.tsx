...
export const TransformerBlockDiagram = React.memo(({ copy }: TransformerBlockDiagramProps) => {
  return (
    <div style={{
      ...
      <div style={{ width: '4px', height: '30px', background: sw.tintStrong }} />
      ...
      <div style={{ width: '4px', height: '30px', background: sw.tintStrong, position: 'relative' }}>
        <div style={{ position: 'absolute', bottom: '-4px', left: '-3px', width: '10px', height: '10px', borderBottom: `2px solid ${sw.tintStrong}`, borderRight: `2px solid ${sw.tintStrong}`, transform: 'rotate(45deg)' }} />
      </div>
