...
const Node: React.FC<{
  ...
  <g transform={`translate(${x} ${y})`}>
    <rect x="0" y="0" width="88" height="108" rx="18" fill="#ffffff" stroke="rgba(128, 144, 175, 0.34)" />
    <rect x="0" y="0" width="88" height="7" rx="18" fill={accent} />
    <text x="44" y="30" textAnchor="middle" fontFamily={fontFamily} fontSize="16.5" fontWeight="700" fill="#233145">
      {title}
    </text>
    <text x="44" y="49" textAnchor="middle" fontFamily={fontFamily} fontSize="11" fontWeight="500" fill="#617183">
      {subtitle}
    </text>
    {children}
  </g>
...
const Arrow: React.FC<{
  ...
  curvature?: number;
  color?: string;
}> = ({ x1, y1, x2, y2, curvature = 0, color = '#8793a6' }) => {
  const midX = (x1 + x2) / 2;
...
export const LearningLoopDiagram: React.FC<LearningLoopDiagramProps> = ({ copy }) => {
  return (
    ...
    >
      ...
      <WrappedText x={34} y={64} text={copy.diagramDescription} maxWidth={470} fontSize={13.5} fill="#637286" />
      ...
      <Arrow x1={448} y1={248} x2={114} y2={248} curvature={56} color="#7f8d9f" />

      <Node x={34} y={118} title={copy.dataTitle} subtitle="input" accent="#8fb2d8">
        <rect x="18" y="72" width="52" height="10" rx="5" fill="#f2c94c" />
        <rect x="18" y="86" width="26" height="10" rx="5" fill="#9fb7cf" />
      </Node>

      <Node x={122} y={118} title={copy.modelTitle} subtitle="aprende" accent="#a855f7">
        <circle cx="28" cy="76" r="7" fill="#f2c94c" stroke="#4f6885" strokeWidth="1.8" />
        <circle cx="60" cy="68" r="7" fill="#8fb2d8" stroke="#4f6885" strokeWidth="1.8" />
        <circle cx="60" cy="90" r="7" fill="#8fb2d8" stroke="#4f6885" strokeWidth="1.8" />
        <path d="M35 76 L53 68" stroke="#6c7d93" strokeWidth="2.1" />
        <path d="M35 76 L53 90" stroke="#6c7d93" strokeWidth="2.1" />
        <path d="M67 68 L67 90" stroke="#6c7d93" strokeWidth="2.1" />
      </Node>

      <Node x={210} y={118} title={copy.predictionTitle} subtitle="saída" accent="#f3b72c">
        <rect x="18" y="72" width="16" height="22" rx="3" fill="#8fb2d8" />
        <rect x="38" y="62" width="16" height="32" rx="3" fill="#f3b72c" />
        <rect x="58" y="54" width="16" height="40" rx="3" fill="#ef8b42" />
      </Node>

      <Node x={298} y={118} title={copy.errorTitle} subtitle="loss" accent="#ef5b5b">
        <path d="M18 82 C28 76, 34 64, 44 54 C54 44, 60 46, 70 62" fill="none" stroke="#5079c7" strokeWidth="3.2" strokeLinecap="round" />
        <path d="M26 54 L56 84" stroke="#ef5b5b" strokeWidth="3.6" strokeLinecap="round" />
        <path d="M56 54 L26 84" stroke="#ef5b5b" strokeWidth="3.6" strokeLinecap="round" />
      </Node>

      <Node x={386} y={118} title={copy.adjustTitle} subtitle="corrige" accent="#00b8f0">
        <rect x="18" y="72" width="14" height="22" rx="3" fill="#8fb2d8" />
        <rect x="38" y="60" width="14" height="34" rx="3" fill="#f3b72c" />
        <rect x="58" y="50" width="14" height="44" rx="3" fill="#ef8b42" />
        <path d="M68 44 C76 48, 80 56, 80 64" fill="none" stroke="#00b8f0" strokeWidth="3.2" strokeLinecap="round" />
        <path d="M80 64 L73 59" stroke="#00b8f0" strokeWidth="3.2" strokeLinecap="round" />
      </Node>

      <text x="270" y="304" textAnchor="middle" fontFamily={fontFamily} fontSize="20" fontWeight="700" fill="#233145">
        {copy.loopLabel}
      </text>
      <WrappedText x={270} y={328} text={copy.footerLabel} maxWidth={420} fontSize={13.5} weight={500} fill="#637286" anchor="middle" />
    </svg>
  );
};
