...
import type { LangchainWhyCopy } from '../../../types/slide';
import { sw } from '../../../theme/tokens';

interface LangchainWhyProps {
  copy: LangchainWhyCopy;
}

export const LangchainWhyVisual = React.memo(({ copy }: LangchainWhyProps) => {
  return (
    <div style={{
      width: '100%',
      padding: '32px',
