...
*   **Cosine Decay:** Decreases the step at the end for the model to do careful fine-tuning.`,
  ...
  visual: {
    id: 'grad-norm-stability-visual',
    copy: {
      'pt-br': {
        schedulerTitle: 'Scheduler: Warmup + Cosine Decay',
        warmup: 'Acelera',
        decay: 'Ajuste Fino',
        gradNormTitle: 'Grad Norm: Cuidado com os Picos',
        spike: 'PICO DE GRADIENTE',
      },
      'en-us': {
        schedulerTitle: 'Scheduler: Warmup + Cosine Decay',
        warmup: 'Accelerate',
        decay: 'Fine-Tune',
        gradNormTitle: 'Grad Norm: Watch for Spikes',
        spike: 'GRADIENT SPIKE',
      },
    },
  },
});
