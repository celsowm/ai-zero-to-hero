...
\`\`\``,
  ...
  visual: {
    ...
    copy: {
      'pt-br': {
        snippetId: 'transformers/moe-pytorch',
        tabCode: 'Código',
        tabDiagram: 'Diagrama',
        inputLabel: 'Input Tokens',
        embedLabel: 'Embeddings',
        residualLabel: 'Stream Residual',
        blockLabel: 'Camada MoE',
        attentionLabel: 'Router + Gating',
        normLabel: 'LayerNorm',
        mlpLabel: 'Experts (MLPs)',
        outputLabel: 'Output',
        blocksLabel: '× N camadas MoE',
      },
      'en-us': {
        snippetId: 'transformers/moe-pytorch',
        tabCode: 'Code',
        ...
        blockLabel: 'MoE Layer',
        attentionLabel: 'Router + Gating',
        normLabel: 'LayerNorm',
        mlpLabel: 'Experts (MLPs)',
        outputLabel: 'Output',
        blocksLabel: '× N MoE layers',
      },
    },
  },
});
