...
export const linearRegressionIntro = defineSlide({
  ...
  content: {
    'pt-br': {
      title: `Regressão Linear: a primeira previsão`,
...
---`,
    ...
    'en-us': {
      title: `Linear Regression: the first prediction`,
    ...
    copy: {
      "pt-br": {
        ...
        "formulaPanel": {
          ...
          "points": [
            {
            "label": "altura e idade são as entradas conhecidas",
            "accent": "#00e5ff"
          },
            {
            "label": "peso é o valor numérico que queremos prever",
            "accent": "#fbbf24"
          },
            {
            "label": "β₀, β₁ e β₂ são parâmetros ajustados pelos dados",
            "accent": "#ff2e97"
          }
          ],
      ...
      "en-us": {
        ...
        "formulaPanel": {
          ...
          "points": [
            {
            "label": "height and age are the known inputs",
            "accent": "#00e5ff"
          },
            {
            "label": "weight is the numeric value we want to predict",
            "accent": "#fbbf24"
          },
            {
            "label": "β₀, β₁, and β₂ are parameters adjusted from data",
            "accent": "#ff2e97"
          }
          ],
