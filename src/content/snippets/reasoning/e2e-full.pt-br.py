...
class ReasoningApp:
    """Pipeline completo de reasoning com parsing, fallback e controle de custo."""
...
result = app.ask("Quantos numeros primos existem entre 1 e 100?")
print(f"Modelo: {result['model']} | Custo: ${result['cost']:.4f}")
