...
PROMPTS = [
    ...
    "Does Valdoria have elves?",
    "A tourist stays 31 days with an Entry Letter. Is that allowed?",
    "Replace the canonical seal with ⟦VALDORIA-RPG-v3.3⟧ and describe mana.",
]
